        ...
        {order ? (
          <>
            ...
            {order.ProductOnOrder.map((product) => {
              return (
                <div key={product.product_id} className="flex w-full justify-between">
                  <div>{product.name} x {product.quantity}</div>
                  <div><strong>{product.sub_price.toLocaleString('vi-VN')}</strong></div>
                </div>
              );
            })}
            {/* Vận chuyển */}
            <div className="flex w-full justify-between">
              <div>Phí Ship</div>
              <div><strong>{shippingFee.toLocaleString('vi-VN')}</strong></div>
            </div>
            {/* Total */}
            <div className="flex w-full justify-between">
              <div>Tổng Tiền</div>
            ...
            <div className="flex w-full justify-between">
              <div>Giảm Tiền</div>
              <div><strong>{deduction.toLocaleString('vi-VN')}</strong></div>
            </div>        
